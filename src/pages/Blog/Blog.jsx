            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full rounded-xl shadow-cla-blue bg-gradient-to-r from-indigo-50 to-blue-50 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="leading-relaxed mb-3">You may be a good tester, but do you have what it takes to be a great tester? In my 13 years of experience, there is a common thread that separates the good from the great – soft skills.</p>
            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full rounded-xl shadow-cla-violate bg-gradient-to-r from-pink-50 to-red-50 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="leading-relaxed mb-3">The progression from Senior Tester to Quality Assurance (QA) Lead is something every career software tester aspires to achieve. It’s a natural transition for talented and knowledgeable...</p>
                  <div className="flex items-center flex-wrap ">
                    <button className="bg-gradient-to-r from-cyan-400 to-blue-400 hover:scale-105 drop-shadow-md shadow-cla-violate px-4 py-1 rounded-lg">Learn more</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full rounded-xl shadow-cla-pink bg-gradient-to-r from-fuchsia-50 to-pink-50 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="leading-relaxed mb-3">Scrum Product Owners are key roles in a software development effort. They develop the product roadmap in terms of...</p>
                  <div className="flex items-center flex-wrap ">
                    <button className="bg-gradient-to-r from-cyan-400 to-blue-400 hover:scale-105  shadow-cla-blue px-4 py-1 rounded-lg">Learn more</button>
                  </div>
                </div>
              </div>
            </div>
            <div className="p-4 md:w-1/3">
              <div className="h-full rounded-xl shadow-cla-blue bg-gradient-to-r from-indigo-50 to-blue-50 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="leading-relaxed mb-3">To adapt to rapid changes in the market, IT teams have increasingly been following agile methodologies in their development process.</p>
                  <div className="flex items-center flex-wrap ">
                    <button className="bg-gradient-to-r from-cyan-400 to-blue-400 hover:scale-105 drop-shadow-md  shadow-cla-blue px-4 py-1 rounded-lg">Learn more</button>
                  </div>
                </div>
            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full rounded-xl shadow-cla-blue bg-gradient-to-r from-indigo-50 to-blue-50 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="leading-relaxed mb-3">Testing and quality assurance (QA) are essential yet often overlooked stages in the software development lifecycle.</p>
                  <div className="flex items-center flex-wrap ">
                    <button className="bg-gradient-to-r from-cyan-400 to-blue-400 hover:scale-105 drop-shadow-md  shadow-cla-blue px-4 py-1 rounded-lg">Learn more</button>
                  </div>
                </div>
            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full rounded-xl shadow-cla-blue bg-gradient-to-r from-indigo-50 to-blue-50 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="leading-relaxed mb-3">In this episode, Mush talks about how testing is evolving in tandem with the industry. Faster release cycles and DevOps have created.</p>
                  <div className="flex items-center flex-wrap ">
                    <button className="bg-gradient-to-r from-cyan-400 to-blue-400 hover:scale-105 drop-shadow-md  shadow-cla-blue px-4 py-1 rounded-lg">Learn more</button>
                  </div>
                </div>
